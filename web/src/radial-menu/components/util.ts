...
export function getInnerArc(startAngle: number, endAngle: number, innerRadius: number, outerRadius: number): string {
  ...
  return `
          M ${outerRadius} ${outerRadius}
          m ${innerX1} ${innerY1}
          A ${outerRadius} ${outerRadius} 0 ${largeArcFlag} 1 ${innerX2 + outerRadius} ${innerY2 + outerRadius}
          A ${innerRadius} ${innerRadius} 0 ${largeArcFlag} 0 ${outerRadius + innerX1} ${outerRadius + innerY1}`;
}
